    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid sm:grid-cols-3 gap-16 sm:gap-8 mt-16 sm:mt-24">
        <div className="text-center">
          ...
          <Reveal>
          <h3 className="font-headline text-xl sm:text-2xl mt-6 sm:mt-10">1. Reimagine</h3>
        ...
        <div className="text-center">
          ...
          <Reveal>
          <h3 className="font-headline text-xl sm:text-2xl mt-6 sm:mt-10">2. Redesign</h3>
          <p className="leading-relaxed mt-4">
        ...
        <div className="text-center">
          ...
          <Reveal>
          <h3 className="font-headline text-xl sm:text-2xl mt-6 sm:mt-10">3. Relaunch</h3>
          <p className="leading-relaxed mt-4">
