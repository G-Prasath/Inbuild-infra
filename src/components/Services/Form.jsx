    ...
    <div className="max-w-screen-xl mx-auto my-7 lg:px-20" id="contact">
      <form action="" method="post">
        <div className="w-full p-8 my-4 mr-auto shadow-2xl md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 rounded-2xl">
          <div className="flex">
            <h1 className="text-5xl text-[#A85168] font-bold">Get In Touch</h1>
          </div>
          ...
          <div className="w-1/2 my-2 lg:w-1/4">
            <button type="submit" className="w-full p-3 text-sm font-bold tracking-wide text-gray-100 uppercase bg-[#A12347] rounded-xl hover:bg-blue-700 focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col text-white">
          <div className="flex w-2/3 my-4 lg:w-1/2">
            ...
            <div>
              ...
              <p className="text-gray-200" style={{ whiteSpace: 'nowrap' }}>27B Grassfield, Lumely</p>
            </div>
          </div>
          <div className="flex w-2/3 my-4 lg:w-1/2">
            ...
            <div>
              ...
              <p className="text-gray-200" style={{ whiteSpace: 'nowrap' }}>Tel:+232-79-15-39-15</p>
            </div>
          </div>
          <div className="flex w-2/3 my-4 lg:w-1/2">
            ...
            <div>
              ...
              <p className="text-gray-200" style={{ whiteSpace: 'nowrap' }}>Email:kanujosephmelvin@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
