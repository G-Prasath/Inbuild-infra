      ...
      <div className="max-w-7xl mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex gap-5 justify-center">
            ...
            <Link to="/" className="px-8 font-bold py-2 text-white bg-[#0693e3] hover:bg-white border hover:border-black hover:text-black transition-all duration-[.5]">Call</Link>
          </div>
        </div>
      </div>
    </div>
