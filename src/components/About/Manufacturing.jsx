  ...
  return (
    <section className="">
      <div className="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
        <div>
          <h2 className="text-3xl font-bold text-center sm:text-4xl w-full">
        ...
        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
          ...
          <div aria-hidden="true" className="mt-10 lg:mt-0 overflow-hidden">
            <img
              width="600"
              height="600"
              ...
              className="mx-auto rounded-lg shadow-lg dark-bg-gray-500 hover:scale-[1.1] hover:duration-[.5] transition-all"
