...
const ServiceCard = ({ img, title, disc, count }) => {
    ...
    return (
        <section className="container mx-auto p-5 md:py-10 px-0 md:p-10 md:px-0">
            ...
            <div className={`${isEven ? "w-full flex items-center justify-end" : ""}`}>
                    <img
                ...
                <div className={`content bg-white p-2 pt-8 md:p-12 pb-12 lg:max-w-xl w-full lg:absolute top-[25%] ${isEven ? 'left-[10%]' : 'right-[10%]'} lg:border lg:border-[#343333]`}>
                ...
                <p className={`text-[130px] font-bold text-[#000] absolute top-[-5%] ${isEven? "left-10" : "right-10"} opacity-[.3] z-[-1]`}>
                    0{count}
                </p>
            </section>
        </section>
