...
const Form = () => {
  const list = ["Sales Executive", "Digital Marketing", "Web Developer", "Finance", "Sales Manager"];
            ...
            <div className=" max-sm:w-full md:w-3/4 lg:w-2/3 xl:w-1/2">
              ...
              <div className="flex flex-col md:flex-row">
                <input
                  id="name"
                  type="text"
                  className="my-2 py-2 px-4 rounded-md bg-gray-900 text-gray-300 w-full md:w-1/2 md:mr-2 outline-none"
                  placeholder="Name"
                />
                <input
                  id="email"
                  type="email"
                  className="my-2 py-2 px-4 rounded-md bg-gray-900 text-gray-300 w-full md:w-1/2 md:ml-2 outline-none"
                  placeholder="Email"
                />
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-5">
                <input
                  ...
                  type="text"
                  placeholder="Subject"
                  className="my-2 py-2 px-4 rounded-md bg-gray-900 text-gray-300 w-full md:w-1/2 outline-none"
                />
